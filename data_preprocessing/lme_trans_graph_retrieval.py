...
graph_retrival_results_file = f"{PROJECT_ROOT}/data/graph_s-llama/graph_retrieval_results-contriever.json"
output_file = f"{PROJECT_ROOT}/data/graph_s-llama/graph_retrieval_results-contriever_translated.jsonl"
# graph_retrival_results_file = f"{PROJECT_ROOT}/data/graph_m-llama-3.1-8b/graph_retrieval_results-e20-contriever.json"
